...
function initClient(sessionId, config, customUserAgent) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var waPage, cacheEnabled, blockCrashLogs, _waPage, blockAssets, interceptAuthentication, quickAuthed, patterns, authCompleteEv_1, sessionjsonpath, sessionjson;
        var _this = this;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    _a = _b.sent();
                    return [3, 8];
                case 6: return [4, puppeteer.launch(__assign({ executablePath: "/usr/bin/chromium-browser", headless: true, devtools: false, args: __spreadArrays(puppeteer_config_1.puppeteerConfig.chromiumArgs) }, config))];
                case 7:
                    _a = _b.sent();
                    _b.label = 8;
                case 8:
